...
def mlxtend_apriori(transcation, min_surpport, min_threshold):
    ...
    # print("-"*60)
    result = {'itemsets':frequent_itemsets,'rules':rules}
    return result
...
if __name__ == '__main__':
    ...
    min_threshold = 0.45
    result = {}
    result = efficient_apriori(transcation1_generate(path), min_support, min_confidence)
    result = mlxtend_apriori(transcation2_generate(path), min_support, min_threshold)
